...
const QA = [
  ...
  ['Who can change a record?', 'Only the state administrator, after the village officer and the auditor have each approved. Every change is written to a tamper-evident log.'],
